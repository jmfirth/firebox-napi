...
pub(crate) fn is_known_napi_import(name: &str) -> bool {
    matches!(
        ...
        "napi_wasm_init_env"
            ...
            // firebox#352 Wave-1: wasmer-extension namespaces — these
            // are wired in register_napi_imports below but were missing
            // from the classifier, causing edgejs.webc to misclassify as
            // NapiVersion::Unknown and bail at instantiation. Functions
            // are part of the napi_extension_wasmer_v0 surface, imported
            // by the runtime under the core napi namespace.
